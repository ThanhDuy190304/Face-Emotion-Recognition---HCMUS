...
train_dataset = Four4All(csv_file='rafdb/train_labels.csv',
                         img_dir='rafdb/train', transform=trainsform)
...
val_dataset = Four4All(csv_file='rafdb/val_labels.csv',
                        img_dir='rafdb/val/', transform=trainsform)
...
test_dataset = Four4All(csv_file='rafdb/test_labels.csv',
                        img_dir='rafdb/test', transform=trainsform)
